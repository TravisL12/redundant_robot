...
import WelcomeToMac from "../images/sheepshaver/welcome-to-mac.jpg"
import BasiliskPreference from "../images/sheepshaver/basiliskPreference.jpg"
    ...
    <div className="sheepshaver">
      ...
      <div className="text">
        ...
        <p>
          ...
          docs for Basilisk or SheepShaver and so you're better looking there
          for guidance on how to get the apps running. Ultimately I feel the
          biggest help that I can provide here are the ROMs and disk images. But
          maybe I'm wrong,{" "}
      ...
      <div className="text">
        ...
        <p>
          ...
          ) you may be dreaming about Getting your old Mac Software up and
          running huh? But where to start? With your modern Mac you start
          opening up the Emulators and start getting to it only to realize that
          you need a few things don't you?
        </p>
      </div>
      ...
      <div className="text">
        <p>
          I'll save everyone some time with a bootable Mac OS 7 and 9 disk
          image.
        </p>
      </div>
